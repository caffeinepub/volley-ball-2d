...
export class Backend implements backendInterface {
    ...
    async getInput(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getInput(arg0);
    ...
    async getRoomInfo(arg0: string): Promise<{
        guestJoined: boolean;
        hostJoined: boolean;
    } | null> {
        if (this.processError) {
    ...
    async getState(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
    ...
    async sendInput(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.sendInput(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendState(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.sendState(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [{
        guestJoined: boolean;
        hostJoined: boolean;
    }]): {
    guestJoined: boolean;
